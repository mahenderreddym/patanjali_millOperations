      ...
      <div class="q-mt-md">
        <q-markup-table class="no-border" flat style="table-layout: fixed">
          <thead>
            <tr>
              <th
                class="text-left text-primary text-weight-bold"
                style="width: 33.33%"
              >
                Report Type
              </th>
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center text-red text-bold">
                {{ sterFormData.length }}
              </td>
            ...
            <tr>
              <td class="text-left">Turbine Log Report</td>
              <td class="text-center text-red text-bold">
                {{ turbineFormData.length }}
              </td>
              <td class="text-center">
                <q-icon
                  name="sync"
            ...
            <tr>
              <td class="text-left">Boiler Log Report</td>
              <td class="text-center text-red text-bold">
                {{ boilerFormData.length }}
              </td>
              <td class="text-center">
                <q-icon
                  name="sync"
            ...
            <tr>
              <td class="text-left">Shift Report</td>
              <td class="text-center text-red text-bold">
                {{ shiftFormData.length }}
              </td>
              <td class="text-center">
                <q-icon
                  name="sync"
        ...
        .then(async (db) => {
          ...
          if (this.db) {
            ...
            this.sterFormData = data.sterFormData.filter((each) => {
              ...
              if (
                each.plant_code === this.userDetails.plant_code &&
                each.state_code === this.userDetails.state_code
              ) {
                return each;
              }
            });
